...
class SuggestionsPage extends StatefulWidget {
  ...
  @override
  State<SuggestionsPage> createState() => _PageState();
}

class _PageState extends State<SuggestionsPage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Unused Apps', style: TextStyle(color: Colors.orange[400]),),
      ),
      body:Material(
        color: Colors.black,
        child: Padding(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) {
          ...
          return ListTile(
            ...
            title: Text(appName ?? 'Unknown',  style: TextStyle(color: Colors.white),),
     ...
     floatingActionButton: FloatingActionButton(
      ...
      floatingActionButtonLocation: FloatingActionButtonLocation
          .centerDocked, // Change this to FloatingActionButtonLocation.endDocked 
    );
  }
}
